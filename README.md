...
- 内容与出题：支持本地 Challenge 包导入 Registry、150 条权威题型蓝图导入、对象资产记录、硬约束过滤 + BM25 风格全文检索、候选组合计划、教师 Brief 解析、模型辅助生成题目版本草稿、无候选时生成定制靶场代码包草稿、验证报告和教师审批发布。
...
11. [docs/development/authoritative-blueprint-catalog.md](/Users/fisherder/Desktop/研究生/Security_Class_Tool/docs/development/authoritative-blueprint-catalog.md)：150 条权威题型蓝图、导入、检索组合和无候选定制生成流程。
