...
- 课堂题库：教师可把已发布的 ChallengeVersion 创建为课程题库条目，设置开始/截止时间，执行发布、下架、修改、删除、回收站和恢复；学生只看到本课程已发布题目，并从题库获取本人隔离环境。
...
- Web 前端：学生题库、学生终端工作台、成绩证据页、教师题库、教师题目验证报告页、教师 live monitor 页面。
