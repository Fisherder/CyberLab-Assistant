...
- 内容与出题：支持本地 Challenge 包导入 Registry、对象资产记录、BM25 风格全文检索、教师 Brief 解析、模型辅助生成题目版本草稿、验证报告和教师审批发布。
...
- pgvector/OpenSearch 级别的语义向量检索和大规模题库质量排序，当前本地实现为硬约束过滤加 BM25 风格全文检索。
